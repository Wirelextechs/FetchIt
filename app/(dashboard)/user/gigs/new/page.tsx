    ...
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center max-w-md mx-auto px-6 text-center">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-slate-800 mb-2">Gig Posted!</h2>
          ...
          <div className="bg-amber-50 border border-amber-100 rounded-2xl p-4 text-left mb-6">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-bold text-amber-700 uppercase tracking-wide">Shadow Timer Active</span>
            </div>
          ...
          <p className="text-xs text-slate-400">Redirecting you to your gigs…</p>
        </motion.div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-slate-50 max-w-md mx-auto flex flex-col">
      ...
      <div className="bg-white sticky top-0 z-20 px-4 pt-10 pb-4 border-b border-slate-100 shadow-sm">
        <div className="flex items-center gap-3 mb-1">
          ...
          <h1 className="text-xl font-bold text-slate-800">Post a Gig</h1>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 pb-32">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-4 shadow-sm">
          ...
          <textarea
            ...
            rows={4}
            className="w-full mt-2 text-sm text-slate-800 bg-slate-50 border border-slate-100 rounded-xl p-3 outline-none focus:ring-2 focus:ring-emerald-400 resize-none placeholder:text-slate-400 transition-all"
          />
          <p className={`text-xs mt-1 text-right ${form.description.length < 10 && form.description.length > 0 ? "text-red-400" : "text-slate-400"}`}>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-4 shadow-sm space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-sm text-slate-800 bg-slate-50 border border-slate-100 rounded-xl p-3 outline-none focus:ring-2 focus:ring-emerald-400 placeholder:text-slate-400 transition-all"
            />
          </div>
          ...
          <div className="flex items-center gap-3 -my-1">
            ...
            <Navigation className="w-4 h-4 text-slate-300 rotate-180" />
            <div className="flex-1 border-t border-dashed border-slate-200" />
          </div>
          ...
          {/* No-pin note */}
          <p className="text-[11px] text-slate-400 bg-slate-50 rounded-xl p-2.5 border border-slate-100">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-4 shadow-sm">
          ...
          <div className="relative mt-2">
            ...
            <input
              ...
              placeholder="0.00"
              className="w-full pl-14 pr-4 py-4 text-xl font-bold text-slate-800 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:ring-2 focus:ring-emerald-400 placeholder:text-slate-300 transition-all"
            />
          </div>
              ...
              >
                <div className="mt-3 space-y-1.5 text-xs text-slate-500">
                  {[
                    ...
                    <div key={label} className="flex justify-between bg-slate-50 px-3 py-2 rounded-xl border border-slate-100">
                      <span>{label}</span>
