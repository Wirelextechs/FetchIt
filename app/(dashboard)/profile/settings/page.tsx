...
export default function AccountSettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-white max-w-md mx-auto pb-20 shadow-xl border-x border-slate-100">
      <header className="px-6 py-8 flex items-center gap-4 border-b border-slate-50">
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="space-y-6">
          <div className="flex flex-col items-center pb-4">
             <div className="w-20 h-20 bg-slate-100 rounded-[28px] flex items-center justify-center text-slate-400 mb-2 border border-slate-200 shadow-inner">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border-none rounded-2xl py-4 pl-12 pr-4 text-slate-800 font-bold placeholder:text-slate-300 focus:ring-2 focus:ring-emerald-500/20 transition-all outline-none"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative opacity-60">
                ...
                <input
                  ...
                  value={phoneNumber}
                  disabled
                  className="w-full bg-slate-50 border-none rounded-2xl py-4 pl-12 pr-4 text-slate-800 font-bold outline-none cursor-not-allowed"
                />
              </div>
              <p className="text-[10px] text-slate-400 mt-2 px-1">Phone number cannot be changed once verified.</p>
            </div>
          </div>
        </div>
