    ...
    <div className="min-h-screen bg-slate-50 max-w-md mx-auto pb-32 border-x border-slate-200 shadow-2xl relative">
      ...
      <div className="px-6 -mt-12 relative z-20 space-y-4">
        ...
        <div className="space-y-3 pt-2">
           ...
           <h2 className="px-2 pt-2 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Support & Legal</h2>
        ...
        {/* Share Banner */}
        <div className="bg-gradient-to-br from-indigo-600 to-blue-700 p-6 rounded-[32px] text-white shadow-xl shadow-blue-500/20 relative overflow-hidden group">
           ...
           <p className="text-xs text-blue-100 leading-relaxed mb-4 relative z-10">Share FetchIt with your friends and family so they can also get things done fast!</p>
           <button 
             onClick={handleShare}
             className="bg-white text-blue-700 text-[10px] font-black uppercase tracking-wider px-6 py-2.5 rounded-full relative z-10 shadow-lg active:scale-95 transition-transform"
           >
             Share App
           </button>
        </div>
